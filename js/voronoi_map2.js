...
voronoiMap = function(map, url, initialSelections) {
  ...
  var selectPoint = function() {
    ...
    console.log("tt" +JSON.stringify(cell));
  ...
  var drawPointTypeSelection = function() {
    showHide('#selections');
    console.log("test "+ JSON.stringify(pointTypes.values()));
  ...
  var draw = function() {
    ...
    //pointsFilteredToSelectedTypes().filter(function(d) {
    ...
    voronoi(filteredPoints).forEach(function(d) {
      ...
      //console.log("khabar " + JSON.stringify(d));
      d.point.cell = d;
    });
    ...
    console.log("json"+JSON.stringify(topLeft));
  ...
  map.on('ready', function() {
    d3.csv(url, function(csv) {
      ...
      points.forEach(function(point) {
        console.log("what ");
        pointTypes.set('Waitrose', {type: 'Waitrose', color: '609128'});
      })
